const PRODUCTS = [
 {id:"hoodie", name:"Ocotillo Tennis Pullover Hoodie", img:"assets/hoodie.jpg?v=3", color:"Navy", hex:"#1d2b4a", fit:"Unisex", sizes:["XS","S","M","L","XL","2XL","3XL"], youth:true, personalize:true, tag:"Best seller",
 ...
 {id:"crew", name:"Village Crewneck Sweatshirt", img:"assets/crew.jpg?v=3", color:"Heather Grey", hex:"#b8b8b8", fit:"Unisex", sizes:["XS","S","M","L","XL","2XL","3XL"], youth:true, personalize:true,
 ...
 {id:"qzip", name:"Ocotillo Performance Quarter-Zip", img:"assets/qzip.jpg?v=3", color:"Navy", hex:"#1d2b4a", fit:"Men's & Ladies'", sizes:["XS","S","M","L","XL","2XL","3XL"], youth:false, personalize:true, tag:"Coach favorite",
 ...
 {id:"polo", name:"Ocotillo Court Polo", img:"assets/polo.jpg?v=3", color:"White", hex:"#ffffff", fit:"Men's & Ladies'", sizes:["XS","S","M","L","XL","2XL","3XL"], youth:false, personalize:false,
 ...
 {id:"cap", name:"Village Structured Cap", img:"assets/cap.jpg?v=3", color:"Navy", hex:"#1d2b4a", fit:"One size", sizes:["One size"], youth:false, personalize:false,
 ...
 {id:"tee", name:"Ocotillo Performance Tee", img:"assets/tee.jpg?v=3", color:"Heather Grey", hex:"#b8b8b8", fit:"Adult & Youth", sizes:["XS","S","M","L","XL","2XL","3XL"], youth:true, personalize:true,
