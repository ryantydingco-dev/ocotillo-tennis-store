const PRODUCTS = [
 {id:"hoodie", name:"Ocotillo Tennis Pullover Hoodie", img:"assets/hoodie.jpg?v=4", color:"Navy", hex:"#1d2b4a", fit:"Unisex", sizes:["XS","S","M","L","XL","2XL","3XL"], youth:true, personalize:true, tag:"Best seller",
 ...
 {id:"qzip", name:"Ocotillo Performance Quarter-Zip", img:"assets/qzip.jpg?v=4", color:"Navy", hex:"#1d2b4a", fit:"Men's & Ladies'", sizes:["XS","S","M","L","XL","2XL","3XL"], youth:false, personalize:true, tag:"Coach favorite",
 ...
 {id:"tank", name:"Ladies' Court Racerback Tank", img:"assets/tank.jpg?v=6", color:"Heather Grey", hex:"#b8b8b8", fit:"Ladies'", sizes:["XS","S","M","L","XL","2XL"], youth:true, personalize:true, tag:"New",
 ...
 {id:"shorts", name:"Ocotillo Performance Shorts", img:"assets/shorts.jpg?v=6", color:"Navy", hex:"#1d2b4a", fit:"Men's & Boys'", sizes:["XS","S","M","L","XL","2XL"], youth:true, personalize:false,
 ...
 {id:"tee", name:"Ocotillo Performance Tee", img:"assets/tee.jpg?v=4", color:"Heather Grey", hex:"#b8b8b8", fit:"Adult & Youth", sizes:["XS","S","M","L","XL","2XL","3XL"], youth:true, personalize:true,
 ...
 {id:"visor", name:"Village Tennis Visor", img:"assets/visor.jpg?v=4", color:"Navy", hex:"#1d2b4a", fit:"One size", sizes:["One size"], youth:false, personalize:false, tag:"New",
  blurb:"Classic court visor with the Village wordmark embroidered across the front band. Sun off your face, hair free, nothing in the way of the serve.", bullets:["Embroidered front band","Sweat-wicking inner band","Adjustable closure, adult and youth"]},
 {id:"towel", name:"Ocotillo Court Towel", img:"assets/towel.jpg?v=6", color:"White", hex:"#ffffff", fit:"16 x 26 in", sizes:["One size"], youth:false, personalize:true,
  blurb:"Plush cotton court towel with the Village lockup embroidered in navy. The bench essential in a Chandler summer.", bullets:["100% cotton terry","Embroidered, wash after wash","Optional player name below the logo"]},
 {id:"crew", name:"Village Crewneck Sweatshirt", img:"assets/crew.jpg?v=4", color:"Heather Grey", hex:"#b8b8b8", fit:"Unisex", sizes:["XS","S","M","L","XL","2XL","3XL"], youth:true, personalize:true,
